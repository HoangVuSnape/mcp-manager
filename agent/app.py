...
def setup_sidebar():
    ...
    st.sidebar.title("🔐 Đăng nhập KingWork")

    username = st.sidebar.text_input("Username", value="admin")
    password = st.sidebar.text_input("Password", value="Aa@123456", type="password")
    x_tenant_id = st.sidebar.text_input("X-Tenant-ID", value="uat")
    ...
    if st.sidebar.button("Login"):
        ...
        if token:
            ...
            st.sidebar.error("❌ Đăng nhập thất bại, vui lòng kiểm tra lại thông tin.")
