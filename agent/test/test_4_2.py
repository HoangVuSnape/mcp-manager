...
Nếu câu hỏi có liên quan đến bảng chấm công thì trước hết phải làm như sau
- Lấy được id của nhân viên từ câu hỏi thông qua tool get_list_employee
- Gọi tool get_employee_timesheet_month với id của nhân viên và tháng năm cần lấy
...
async def run(mcp_server: MCPServer):
    ...
    question = "Lấy bảng chấm công theo tháng 5 2025 cho nhân viên tên 'đại' từ hệ thống KingWork."
