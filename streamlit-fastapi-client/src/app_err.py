            ...
            with cols[i]:
                with st.container(border=True):
                    ...
                    with c1:
                        ...
                        current_checkbox_state = st.session_state.individual_selections.get(checkbox_key, False)
                        ...
                        individual_selected = st.checkbox(
                            ...
                            on_change=lambda name=name: handle_individual_checkbox_change(name, tools_on_page)
                        )
